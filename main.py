...
def open(tableName,itemID_parent,tableName_parent):
    ...
    while not menu_exit:
        if dbTable.isEmpty(tableName,itemID_parent):
            ...
            if menu_sel == 0:
                dbTable.createItem(tableName,itemID_parent,False)
            elif menu_sel == 1:
                menu_exit = True
            ...
            if menu_sel == 0:
                overview.all(tableName,itemID_parent)
            elif menu_sel == 1:
                itemNum = menu.selectItem(tableName,itemID_parent,True)
                ...
                index = menu.selectItem(tableName,itemID_parent,True)
...
def openSubtasks(tableName,itemID_parent,tableName_parent):
    ...
    while not menu_exit:
        if dbTable.isEmpty(tableName,itemID_parent):
            ...
            if menu_sel == 0:
                dbTable.createItem(tableName,itemID_parent,True)
            elif menu_sel == 1:
                menu_exit = True
            ...
            if menu_sel == 0:
                ...
                index = menu.selectItem(tableName,itemID_parent,False)
                dbTable.addLogWithRef(tableName,itemID_parent,index)
            elif menu_sel == 2:
                dbTable.createItem(tableName,itemID_parent,True)
            elif menu_sel == 3:
                index = menu.selectItem(tableName,itemID_parent,True)
